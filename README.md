...
мониторинг Prometheus + Grafana. Ручки CRUD покрыты unit-тестами (coverage 70%+) при помощи библиотеки gomock, в папке есть файлы 
с тестами для определенного слоя проекта. Возможно добавить более строгую валидацию проекту.
