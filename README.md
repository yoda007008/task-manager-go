...
мониторинг Prometheus + Grafana. В процессе CRUD покрывается 
unit-тестами при помощи библиотеки gomock, в папке есть файлы 
с тестами для определенного слоя проекта.
